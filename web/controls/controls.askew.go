...
var αpopupFromTemplateTemplate = js.Global().Get("document").Call("createElement", "template")

func init() {
	αpopupFromTemplateTemplate.Set("innerHTML", `
	<!--data-->
...
// popupFromTemplate is a DOM component autogenerated by Askew
type popupFromTemplate struct {
	αcd              askew.ComponentData
	Name             askew.StringValue
	Expanded         askew.BoolValue
	selectedPlugin   int
	selectedTemplate int
	Templates        popupSelectableTemplateList
}

// newPopupFromTemplate creates a new component and initializes it with the given parameters.
func newPopupFromTemplate() *popupFromTemplate {
	ret := new(popupFromTemplate)
	ret.askewInit()
	return ret
}

// Init initializes the component with the given arguments.
func (o *popupFromTemplate) Init() {
	o.askewInit()
}

// FirstNode returns the first DOM node of this component.
// It implements the askew.Component interface.
func (o *popupFromTemplate) FirstNode() js.Value {
	return o.αcd.First()
}
...
// The component is initially a DocumentFragment until it gets inserted into
// the main document. It can be manipulated both before and after insertion.
func (o *popupFromTemplate) askewInit() {
	o.αcd.Init(αpopupFromTemplateTemplate.Get("content").Call("cloneNode", true))

	o.Name.BoundValue = askew.NewBoundProperty(&o.αcd, "value", 4)
	o.Expanded.BoundValue = askew.NewBoundClasses(&o.αcd, []string{"menu-expanded"}, 6)
	{
		container := o.αcd.Walk(6, 1)
		o.Templates.Init(container, 1)
		o.Templates.DefaultController = o
...
//
// The component will be inserted in front of 'before', or at the end if 'before' is 'js.Undefined()'.
func (o *popupFromTemplate) InsertInto(parent js.Value, before js.Value) {
	o.αcd.DoInsert(parent, before)
	o.Templates.αmgr.UpdateParent(o.αcd.DocumentFragment(), parent, before)
}

// Extract removes this component from its current parent.
// The component will be in initial state afterwards.
func (o *popupFromTemplate) Extract() {
	o.αcd.DoExtract()
	o.Templates.αmgr.UpdateParent(o.αcd.First().Get("parentNode"), o.αcd.DocumentFragment(), js.Undefined())
}

// Destroy destroys this element (and all contained components). If it is
// currently inserted anywhere, it gets removed before.
func (o *popupFromTemplate) Destroy() {
	o.Templates.DestroyAll()
	o.αcd.DoDestroy()
}
...
func (o *popupInput) askewInit(label string) {
	...
	o.Value.BoundValue = askew.NewBoundProperty(&o.αcd, "value", 3)
	{
		block := o.αcd.Walk()
		{
			var tmp askew.BoundProperty
...
// popupSelectableTemplateController can be implemented to handle external events
// generated by popupSelectableTemplate
type popupSelectableTemplateController interface {
	choose(pluginIndex int, templateIndex int, active bool)
}

var αpopupSelectableTemplateTemplate = js.Global().Get("document").Call("createElement", "template")

func init() {
	αpopupSelectableTemplateTemplate.Set("innerHTML", `
  <!--data-->
	<!--handlers-->
	<!--controller-->
...
// popupSelectableTemplate is a DOM component autogenerated by Askew
type popupSelectableTemplate struct {
	αcd askew.ComponentData
	// Controller is the adapter for events generated from this component.
	// if nil, events that would be passed to the controller will not be handled.
	Controller    popupSelectableTemplateController
	Active        askew.BoolValue
	Height        askew.StringValue
	OffsetHeight  askew.StringValue
	pluginIndex   int
	templateIndex int
}

// newPopupSelectableTemplate creates a new component and initializes it with the given parameters.
func newPopupSelectableTemplate(pluginName string, templateName string, descr string) *popupSelectableTemplate {
	ret := new(popupSelectableTemplate)
	ret.askewInit(pluginName, templateName, descr)
	return ret
}

// Init initializes the component with the given arguments.
func (o *popupSelectableTemplate) Init(pluginName string, templateName string, descr string) {
	o.askewInit(pluginName, templateName, descr)
}

// FirstNode returns the first DOM node of this component.
// It implements the askew.Component interface.
func (o *popupSelectableTemplate) FirstNode() js.Value {
	return o.αcd.First()
}
...
// The component is initially a DocumentFragment until it gets inserted into
// the main document. It can be manipulated both before and after insertion.
func (o *popupSelectableTemplate) askewInit(pluginName string, templateName string, descr string) {
	o.αcd.Init(αpopupSelectableTemplateTemplate.Get("content").Call("cloneNode", true))

	o.Active.BoundValue = askew.NewBoundClasses(&o.αcd, []string{"pure-menu-active"}, 7)
	o.Height.BoundValue = askew.NewBoundStyle(&o.αcd, "height", 7)
	o.OffsetHeight.BoundValue = askew.NewBoundProperty(&o.αcd, "offsetHeight", 7, 1, 1)
	{
		block := o.αcd.Walk()
		{
			var tmp askew.BoundProperty
			tmp.Init(askew.WalkPath(block, 7, 1, 1, 1, 1), "textContent")
			askew.Assign(&tmp, pluginName)
		}
		{
			var tmp askew.BoundProperty
			tmp.Init(askew.WalkPath(block, 7, 1, 1, 1, 5), "textContent")
			askew.Assign(&tmp, templateName)
		}
		{
			var tmp askew.BoundProperty
			tmp.Init(askew.WalkPath(block, 7, 1, 1, 3), "textContent")
			askew.Assign(&tmp, descr)
		}
	}
	{
		src := o.αcd.Walk(7, 1)
...
//
// The component will be inserted in front of 'before', or at the end if 'before' is 'js.Undefined()'.
func (o *popupSelectableTemplate) InsertInto(parent js.Value, before js.Value) {
	o.αcd.DoInsert(parent, before)
}

// Extract removes this component from its current parent.
// The component will be in initial state afterwards.
func (o *popupSelectableTemplate) Extract() {
	o.αcd.DoExtract()
}

// Destroy destroys this element (and all contained components). If it is
// currently inserted anywhere, it gets removed before.
func (o *popupSelectableTemplate) Destroy() {
	o.αcd.DoDestroy()
}

func (o *popupSelectableTemplate) αcallclick() {
	o.click()
}
func (o *popupSelectableTemplate) αcallchoose(pluginIndex askew.BoundValue, templateIndex askew.BoundValue, active askew.BoundValue) {
	if o.Controller == nil {
		return
	}
	_pluginIndex := askew.IntValue{BoundValue: pluginIndex}
	_templateIndex := askew.IntValue{BoundValue: templateIndex}
	_active := askew.BoolValue{BoundValue: active}
	o.Controller.choose(_pluginIndex.Get(), _templateIndex.Get(), _active.Get())
}
...
// popupFromTemplateList is a list of popupFromTemplate whose manipulation methods auto-update
// the corresponding nodes in the document.
type popupFromTemplateList struct {
	αmgr   askew.ListManager
	αitems []*popupFromTemplate
}

// Init initializes the list, discarding previous data.
// The list's items will be placed in the given container, starting at the
// given index.
func (l *popupFromTemplateList) Init(container js.Value, index int) {
	l.αmgr = askew.CreateListManager(container, index)
	l.αitems = nil
}

// Len returns the number of items in the list.
func (l *popupFromTemplateList) Len() int {
	return len(l.αitems)
}

// Item returns the item at the current index.
func (l *popupFromTemplateList) Item(index int) *popupFromTemplate {
	return l.αitems[index]
}

// Append appends the given item to the list.
func (l *popupFromTemplateList) Append(item *popupFromTemplate) {
	if item == nil {
		panic("cannot append nil to list")
	}
	l.αmgr.Append(item)
...
// Insert inserts the given item at the given index into the list.
func (l *popupFromTemplateList) Insert(index int, item *popupFromTemplate) {
	var prev js.Value
	if index < len(l.αitems) {
		prev = l.αitems[index].αcd.First()
	}
...
// Remove removes the item at the given index from the list and returns it.
func (l *popupFromTemplateList) Remove(index int) *popupFromTemplate {
	item := l.αitems[index]
	item.Extract()
	copy(l.αitems[index:], l.αitems[index+1:])
	l.αitems = l.αitems[:len(l.αitems)-1]
...
// Destroy destroys the item at the given index and removes it from the list.
func (l *popupFromTemplateList) Destroy(index int) {
	item := l.αitems[index]
	item.Destroy()
	copy(l.αitems[index:], l.αitems[index+1:])
	l.αitems = l.αitems[:len(l.αitems)-1]
...
// DestroyAll destroys all items in the list and empties it.
func (l *popupFromTemplateList) DestroyAll() {
	for _, item := range l.αitems {
		item.Destroy()
	}
	l.αitems = l.αitems[:0]
...
// popupSelectableTemplateList is a list of popupSelectableTemplate whose manipulation methods auto-update
// the corresponding nodes in the document.
type popupSelectableTemplateList struct {
	αmgr              askew.ListManager
	αitems            []*popupSelectableTemplate
	DefaultController popupSelectableTemplateController
}

// Init initializes the list, discarding previous data.
// The list's items will be placed in the given container, starting at the
// given index.
func (l *popupSelectableTemplateList) Init(container js.Value, index int) {
	l.αmgr = askew.CreateListManager(container, index)
	l.αitems = nil
}

// Len returns the number of items in the list.
func (l *popupSelectableTemplateList) Len() int {
	return len(l.αitems)
}

// Item returns the item at the current index.
func (l *popupSelectableTemplateList) Item(index int) *popupSelectableTemplate {
	return l.αitems[index]
}

// Append appends the given item to the list.
func (l *popupSelectableTemplateList) Append(item *popupSelectableTemplate) {
	if item == nil {
		panic("cannot append nil to list")
	}
	l.αmgr.Append(item)
...
// Insert inserts the given item at the given index into the list.
func (l *popupSelectableTemplateList) Insert(index int, item *popupSelectableTemplate) {
	var prev js.Value
	if index < len(l.αitems) {
		prev = l.αitems[index].αcd.First()
	}
...
// Remove removes the item at the given index from the list and returns it.
func (l *popupSelectableTemplateList) Remove(index int) *popupSelectableTemplate {
	item := l.αitems[index]
	item.Extract()
	copy(l.αitems[index:], l.αitems[index+1:])
	l.αitems = l.αitems[:len(l.αitems)-1]
...
// Destroy destroys the item at the given index and removes it from the list.
func (l *popupSelectableTemplateList) Destroy(index int) {
	item := l.αitems[index]
	item.Destroy()
	copy(l.αitems[index:], l.αitems[index+1:])
	l.αitems = l.αitems[:len(l.αitems)-1]
...
// DestroyAll destroys all items in the list and empties it.
func (l *popupSelectableTemplateList) DestroyAll() {
	for _, item := range l.αitems {
		item.Destroy()
	}
	l.αitems = l.αitems[:0]
...
// OptionalpopupFromTemplate is a nillable embeddable container for popupFromTemplate.
type OptionalpopupFromTemplate struct {
	αcur *popupFromTemplate
	αmgr askew.ListManager
}
...
// The contained item, if any, will be placed in the given container at the
// given index.
func (o *OptionalpopupFromTemplate) Init(container js.Value, index int) {
	o.αmgr = askew.CreateListManager(container, index)
	o.αcur = nil
}

// Item returns the current item, or nil if no item is assigned
func (o *OptionalpopupFromTemplate) Item() *popupFromTemplate {
	return o.αcur
}

// Set sets the contained item destroying the current one.
// Give nil as value to simply destroy the current item.
func (o *OptionalpopupFromTemplate) Set(value *popupFromTemplate) {
	if o.αcur != nil {
		o.αcur.Destroy()
	}
	o.αcur = value
...
// Remove removes the current item and returns it.
// Returns nil if there is no current item.
func (o *OptionalpopupFromTemplate) Remove() askew.Component {
	if o.αcur != nil {
		ret := o.αcur
		ret.Extract()
		o.αcur = nil
...
// OptionalpopupSelectableTemplate is a nillable embeddable container for popupSelectableTemplate.
type OptionalpopupSelectableTemplate struct {
	αcur              *popupSelectableTemplate
	αmgr              askew.ListManager
	DefaultController popupSelectableTemplateController
}
...
// The contained item, if any, will be placed in the given container at the
// given index.
func (o *OptionalpopupSelectableTemplate) Init(container js.Value, index int) {
	o.αmgr = askew.CreateListManager(container, index)
	o.αcur = nil
}

// Item returns the current item, or nil if no item is assigned
func (o *OptionalpopupSelectableTemplate) Item() *popupSelectableTemplate {
	return o.αcur
}

// Set sets the contained item destroying the current one.
// Give nil as value to simply destroy the current item.
func (o *OptionalpopupSelectableTemplate) Set(value *popupSelectableTemplate) {
	if o.αcur != nil {
		o.αcur.Destroy()
	}
	o.αcur = value
...
// Remove removes the current item and returns it.
// Returns nil if there is no current item.
func (o *OptionalpopupSelectableTemplate) Remove() askew.Component {
	if o.αcur != nil {
		ret := o.αcur
		ret.Extract()
		o.αcur = nil
