...
type popupInput struct {
	...
	cb    func(input string)
}

// newPopupInput creates a new component and initializes it with the given parameters.
func newPopupInput(label string, cb func(input string)) *popupInput {
	ret := new(popupInput)
...
// Init initializes the component with the given arguments.
func (o *popupInput) Init(label string, cb func(input string)) {
	o.askewInit(label, cb)
}
...
// The component is initially a DocumentFragment until it gets inserted into
// the main document. It can be manipulated both before and after insertion.
func (o *popupInput) askewInit(label string, cb func(input string)) {
...
func newPopupText(caption string, cb func()) *popupText {
	ret := new(popupText)
...
// Init initializes the component with the given arguments.
func (o *popupText) Init(caption string, cb func()) {
	o.askewInit(caption, cb)
}
...
// The component is initially a DocumentFragment until it gets inserted into
// the main document. It can be manipulated both before and after insertion.
func (o *popupText) askewInit(caption string, cb func()) {
